...
public class BoardTest {
    ...
    public void testBlocks() {
        ...
        assertFalse("blocks not placeable on pieces",
                b.legalBlock('a', '1'));
    ...
    public void testUndo() {
        ...
        makeMoves(b0, GAME1);
        assertEquals("second pass failed to reach same position", b2,
                b0);
    ...
    public void testCanMove() {
        ...
        b.setBlock('c', '4');
        makeMoves(b, TEST4);
        checkBoard(b, CANTMOVE);
        assertFalse("shouldn't be able to move", b.canMove(RED));
        assertFalse("shouldn't be able to move", b.canMove(BLUE));
        assertEquals("winner is not red", RED, b.getWinner());
    }
    ...
    private static final PieceColor[][] CANTMOVE = {
